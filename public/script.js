    ...
    if (videoConnectBtn) {
        videoConnectBtn.addEventListener('click', () => {
            ...
            if (label && label.textContent === "New") {
                ...
                const strangerVideo = document.querySelector('.stranger-video');
                const spinner = document.getElementById('connectingCircle');
                if (strangerVideo) strangerVideo.classList.add('connecting');
...
function proceedWithVideoSkip() {
    ...
    const strangerVideo = document.querySelector('.stranger-video');
    const spinner = document.getElementById('connectingCircle');
    if (strangerVideo && !strangerVideo.classList.contains('connecting')) strangerVideo.classList.add('connecting');
    if (spinner && spinner.classList.contains('hidden')) spinner.classList.remove('hidden');
